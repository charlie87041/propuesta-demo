...
public class SourceTransferViewExceptionAdvice {

    private final MessageSource messageSource;

    public SourceTransferViewExceptionAdvice(MessageSource messageSource) {
    ...
    private String resolveRedirectPath(HttpServletRequest request) {
        ...
        return "/admin/product-sources/" + sourceId + "/manage/transfers";
    }
