...
import com.cookiesstore.admin.service.users.AdminUserDomainMissingException;
import com.cookiesstore.admin.service.users.AdminUserEmailExistsException;
import com.cookiesstore.admin.service.users.AdminUserNotFoundException;
...
public class AdminUserService {
    ...
    public AdminUser createAdminUser(String email, String rawPassword) {
        if (adminUserRepository.existsByEmail(email)) {
            throw new AdminUserEmailExistsException(email);
        }
    ...
    public AdminUser createAdminUserWithRole(Long actorUserId, String email, String rawPassword, String roleCode) {
        ...
        String actorDomainCode = resolvePrimaryDomainCode(actorUserId)
            .orElseThrow(AdminUserDomainMissingException::new);
