...
public class EditVpcResourceForm {
    ...
    public static EditVpcResourceForm from(ProjectResourceDefinition definition, VpcConfig config) {
        EditVpcResourceForm form = new EditVpcResourceForm();
        form.setName(definition.getName());
        form.setDescription(definition.getDescription());
        form.setCidrBlock(config.cidrBlock() != null ? config.cidrBlock() : "10.0.0.0/16");
        form.setEnableDnsSupport(config.enableDnsSupport());
        form.setEnableDnsHostnames(config.enableDnsHostnames());
        return form;
    }
